        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 relative h-[60vh] lg:h-[80vh] w-full">
            <FadeIn delay={0.3} direction="left" className="w-full h-full relative">
              ...
              <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1200&q=80" alt="Luxury Real Estate" className="w-full h-full object-cover" />
            </FadeIn>
          </div>
        </div>
      </div>
