        ...
        <div className="container mx-auto px-6 md:px-12 text-center max-w-4xl">
          <FadeIn>
            ...
            <p className="text-xl text-gray-500 leading-relaxed">
              We leverage proprietary market intelligence, high-end visual storytelling, and targeted digital distribution to position your property ahead of the competition.
            </p>
          </FadeIn>
        </div>
      </section>
